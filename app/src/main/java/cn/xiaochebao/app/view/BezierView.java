...
public class BezierView extends FrameLayout {
    ...
    private void init(){
        ...
        exploredImageView.setImageResource(R.drawable.lib_bezierview_tip_anim);
        exploredImageView.setVisibility(View.INVISIBLE);

        tipImageView = new ImageView(getContext());
        tipImageView.setLayoutParams(params);
        tipImageView.setImageResource(R.drawable.lib_bezierview_skin_tips_newmessage_ninetynine);
